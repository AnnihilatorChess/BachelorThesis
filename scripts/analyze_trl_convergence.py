...
print(f"{'Run Name':<35} | {'Model':<15} | {'Epochs':<6} | {'Min Loss':<10} | {'Final Loss':<10} | {'Loss@10':<10} | {'Loss@50':<10}")
print("-" * 105)
...
for r in runs:
    ...
    print(f"{r.name:<35} | {model:<15} | {num_epochs:<6} | {min_loss:<10.5f} | {final_loss:<10.5f} | {loss_at_10:<10.5f} | {loss_at_50:<10.5f}")
