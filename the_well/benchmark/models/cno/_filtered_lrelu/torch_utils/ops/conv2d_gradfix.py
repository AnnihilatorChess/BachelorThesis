...
import contextlib
import torch
# Patched for vendored use: `pkg_resources` is deprecated and removed by default
# in setuptools>=81. `packaging.version.parse` is the modern equivalent and is a
# transitive dependency of pip/setuptools, so it is always available.
